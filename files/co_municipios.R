...
# }
 ...
 #save(lista_mun, file = "lista_mun.RData")
 load("lista_mun.RData")


 CO_MUNICIPIO <- function(cod_mun) {
   
  lista <- lista_mun()
  cod_mun <- as.character(cod_mun)

  find_mun <- function(cod_mun) {

    return(cod_mun)
  }

  result <- sapply(lista[[cod_mun]],  find_mun)
  return(result[[1]])
  
 }  

#CO_MUNICIPIO(5222005)


for_function <- function(cod_mun) {
  lista <- lista_mun()
  
  for (cod in names(lista)) {
...
for_function(5222005)


which_function <- function(cod_mun) {
  lista <- lista_mun()
  cod_mun <- as.character(cod_mun)
  result <- lista[which(names(lista) == cod_mun)]
  return(result[[1]])
}

which_function(5222005)
...
mun <- read.csv("municipios.csv", header = FALSE,  sep = ";")
typeof(mun)
